...
def evaluate_agent_game(agent_move_func: Callable, max_moves: int = 300, return_move_stack: bool = False):
    ...
    """
    engine = chess.engine.SimpleEngine.popen_uci(STOCKFISH_PATH)  # Load the stockfish chess engine
    ...
    return (move_losses, board.move_stack) if agent_move_func is True else move_losses
